            ...
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('admin.login.attemp') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('phone') is-invalid rounded-right @enderror" placeholder="{{ __('admin.username_or_email') }}" name="phone" value="{{ old('phone') }}" required autofocus>
